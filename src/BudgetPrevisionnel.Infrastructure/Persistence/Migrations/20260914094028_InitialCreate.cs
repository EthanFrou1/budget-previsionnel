        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryRules_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawLabel = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CleanedLabel = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    CategoryId = table.Column<int>(type: "integer", nullable: true),
                    IsInternalTransfer = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Color", "Icon", "IsSystemDefault", "Name", "OwnerId", "ParentCategoryId" },
                values: new object[,]
                {
                    { 1, "#F97316", "utensils", true, "Alimentation", null, null },
                    { 2, "#0EA5E9", "home", true, "Logement", null, null },
                    { 3, "#6366F1", "car", true, "Transport", null, null },
                    { 4, "#8B5CF6", "credit-card", true, "Abonnements & téléphonie", null, null },
                    { 5, "#EC4899", "gamepad-2", true, "Loisirs", null, null },
                    { 6, "#EF4444", "heart-pulse", true, "Santé", null, null },
                    { 7, "#22C55E", "trending-up", true, "Revenus", null, null },
                    { 8, "#14B8A6", "piggy-bank", true, "Épargne", null, null },
                    { 9, "#78716C", "receipt", true, "Impôts & taxes", null, null },
                    { 10, "#94A3B8", "ellipsis", true, "Autres", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BankAccountId_Date",
                table: "Transactions",
